            ...
            case VMMDevHGCMParmType_LinAddr:
                ...
                if (cb != 0)
                {
                    ...
                    if (!fIsUser)
                    {
						...
						LogRel(("artem:vbglR0HGCMInternalPreprocessCall rc = %Rrc\n", rc));
						//printf("artem:vbglR0HGCMInternalPreprocessCall rc = %d\n", rc);
                        if (RT_FAILURE(rc))
                        {
                    ...
                    else
                    {
                        ...
                        LogRel(("artem:RTR0MemObjLockUser rc = %Rrc\n", rc));
					//	printf("artem:RTR0MemObjLockUser rc = %d\n", rc);
                        if (RT_FAILURE(rc))
                        {
                        ...
                        LogRel(("artem:RTR0MemUserCopyFrom rc = %Rrc\n", rc));
					//	printf("artem:RTR0MemUserCopyFrom rc = %d\n", rc);                                
                                if (RT_FAILURE(rc))
                                {
                        ...
                        LogRel(("artem:RTR0MemObjLockKernel rc = %Rrc\n", rc));
						//printf("artem:RTR0MemObjLockKernel rc = %d\n", rc);
                            if (RT_FAILURE(rc))
                            {
                                RTMemTmpFree(pvSmallBuf);
                        ...
                        LogRel(("artem:RTR0MemObjAllocPage rc = %Rrc\n", rc));
				//		printf("artem:RTR0MemObjAllocPage rc = %d\n", rc);
                            if (RT_FAILURE(rc))
                                return rc;
                            if (!fCopyIn)
